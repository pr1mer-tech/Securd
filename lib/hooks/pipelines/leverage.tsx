...
import { getPairPrice } from "@/lib/helpers/borrow.helpers";
...
export function leverage(
  ...
  return async function* leveragePipeline() {
    ...
    const adjustedPriceA = BigInt(
      Math.round((tokensUSDPrices.tokenA ?? 0) * 1e6),
    );
    const adjustedPriceB = BigInt(
      Math.round((tokensUSDPrices.tokenB ?? 0) * 1e6),
    );
        ...
        impacts: [
          ...
          },
          {
            ...
            fromAmount:
              ...
              10n ** BigInt((token0.decimals ?? 18) - 9),
          ...
          },
          {
            ...
            fromAmount:
              ...
              10n ** BigInt((token1.decimals ?? 18) - 9),
