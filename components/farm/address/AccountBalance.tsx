		...
		<Table className="text-center">
			...
			<TableBody>
					...
					<TableCell className="border-r">
						<SecurdFormat
							value={bigIntToDecimal(
								...
								pairReservesInfosUn.reserveInfoTokenA?.decimals,
							)}
							decimals={2}
							className="font-bold ml-2"
						/>
					...
					<TableCell>
						<SecurdFormat
							value={bigIntToDecimal(
								...
								pairReservesInfosUn.reserveInfoTokenB?.decimals,
							)}
							decimals={2}
							className="font-bold ml-2"
						/>
				...
				<TableRow>
					<TableHead className="font-bold pl-0 text-center border-r">
						Loan
						<Help>Value of loans in this account</Help>
					</TableHead>
					<TableCell />
