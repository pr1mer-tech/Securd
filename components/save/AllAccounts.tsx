...
export const columns: ColumnDef<ReserveInfo>[] = [
    ...
    },
    {
        ...
        sortingFn: (a, b) => {
            ...
            const depositBalanceA = bigIntToDecimal(_depositBalanceA, a.original.decimals) ?? 0;
            const depositBalanceB = bigIntToDecimal(_depositBalanceB, b.original.decimals) ?? 0;
