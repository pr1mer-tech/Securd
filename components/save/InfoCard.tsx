...
import { toNoDecimal, toFormattedPercentage } from "@/lib/helpers/numberFormat.helpers";
...
const Info = ({ value, name, type = "currency", tooltip }: {
    ...
    <div className="flex flex-col items-center">
        ...
        <p className="text-3xl font-bold">{type == "currency" ? ("$" + toNoDecimal(value)) : toFormattedPercentage(value, 1)}</p>
    </div>
);
